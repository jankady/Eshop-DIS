...
--
-- Počítač: 127.0.0.1
-- Vytvořeno: Čtv 11. dub 2024, 16:07
...
(1, 'Iphone 12', 'img/products/Iphone12.png', 'super fotak pro iphone 12', 15000, 5, '2024-01-31', 1, 1, 1),
(2, 'Asus vivo', 'img/products/ASUSVivoBook.png', 'super nadupaný nootebook', 17000, 1, '2024-01-31', 2, 2, 2),
(3, 'Huawei P30', 'img/products/HuaweiP30.png', 'modrý mobil Huawei', 8000, 0, '2024-01-31', 1, 1, 3),
(4, 'LenovoTab P12', 'img/products/LenovoTabP12.png', 'super tablet Lenova', 11000, 15, '2024-01-31', 1, 3, 4),
(5, 'MacBook air M1', 'img/products/MacBook.png', 'Skvělý nový nadupaný macbook s M1 čipem a slušným rozlišením', 24599, 3, '2024-03-31', 2, 2, 1),
(6, 'Samsung A30 ', 'img/products/SamsungA30.png', 's touch ID a foťák pro pořízení fotek nejlepší kvality', 12800, 12, '2024-01-31', 1, 1, 5),
(7, 'Xiaomi RedmiNote 9', 'img/products/XiaomiRedmiNote9.png', 'nový produkt od Xiaomi s neuvěřitelnou rychlostí', 7899, 4, '2024-03-31', 2, 1, 6),
(8, 'Samsung Galaxy Tab S7', 'img/products/SamsungGalaxyTabS7.png', 'perfektní pro grafiky a profesionaly v kreslení', 450000, 99, '2024-04-17', 1, 3, 5);
